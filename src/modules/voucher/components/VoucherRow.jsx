...
const VoucherRow = ({ voucher: { id, voucher_id, customer_name, customer_email, created_at, total } }) => {
            ...
            <td className="px-6 py-4 text-end">
                <div className="inline-flex rounded-lg border border-gray-300 overflow-hidden">
                    ...
                    <Link
                        ...
                        className="cursor-pointer font-medium text-primary px-3 py-2 hover:bg-gray-50 transition border-r border-gray-300"
                    >
